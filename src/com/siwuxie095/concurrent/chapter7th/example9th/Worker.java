...
public class Worker extends UntypedAbstractActor {
    ...
    public void onReceive(Object message) throws Throwable {
        if (message == Message.WORKING) {
            System.out.println(this.getSelf().path() + "   I am working");
        } else if (message == Message.DONE) {
            System.out.println(this.getSelf().path() + "   stop working");
        } else if (message == Message.CLOSE) {
            System.out.println(this.getSelf().path() + "   I will shutdown");
