...
public class Main {
     ...
     * 这么一个应用呢？答案是肯定的，那就是 Akka。Akka 是一款遵循 Apache 2 许可的开源框架，这意味着，可以
     * 无偿并且几乎没有限制地使用它，包括将它应用于商业环境中。
     *
     * Akka 是用 Scale 编写的，但由于 Scale 和 Java 一样，都是基于 JVM 的语言，本质上，两者并没有什么不同，
     * 所以也可以在 Java 中使用 Akka。
     *
     * 那么使用 Akka 能够带来什么好处呢？
     *
     * 首先，Akka 提供了一种称为 Actor 的并发模型，其粒度比线程更小，这意味着，可以在系统中启用极大量的 Actor。
     *
